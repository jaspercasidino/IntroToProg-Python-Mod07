...
#   AWysocki, 02/28/2024, Modified Script to create classes for Assignment 07
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    # TODO Create a getter for the first_name property (Done)
    @property
    def first_name(self) -> str:
        return self.__first_name.capitalize()

    # TODO Create a setter for the first_name property (Done)
    @first_name.setter
    ...
    # TODO Create a getter for the last_name property (Done)
    @property
    def last_name(self) -> str:
        return self.__last_name.capitalize()

    # TODO Create a setter for the last_name property (Done)
    @last_name.setter
...
class Student(Person):
    ...
    def course_name(self,value: str) -> None:
        if value != "":
            ...
            raise ValueError("Error! Enter a valid course name. No blanks!")
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        try:
            ...
            dict = json.load(file)
            for each in dict:
                student: Student = Student(each["FirstName"],each["LastName"],each["CourseName"])
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        try:
            ...
            student_dictionary: list = []
            for student in student_data:
                stu: dict = {"FirstName": student.first_name, "LastName": student.last_name, "CourseName": student.course_name}
                student_dictionary.append(stu)

            file = open(file_name, "w")

            json.dump(student_dictionary, file)
            file.close()
            print(f"\nStudent information has been saved in {file_name}!")
